...
<div class="container">
    <div class="row col-md-12">
        ...
        <div class="form-entradas col-md-12">
            ...
            @if(isset($caixas))
            {!! Form::model($caixas, ['route' => ['caixaedit.update', $caixas->id], 'class' => 'form-search form-ds', 'file' => true, 'method' => 'PUT'])!!}
            @else
            ...
            <div class="form-group col-md-12 col-xl-12">
                ...
                <div class="form-group col-md-3 col-xl-3">
                    ...
                    {!! Form::select('CONTA', ['placeholder' => 'Escolha a Conta', 'NENHUMA' => 'NENHUMA', 'MENSALIDADE' => 'MENSALIDADE', 'ACORDOS' => 'ACORDOS', 'OUTROS' => 'OUTROS'])!!}
                </div>
                <div class="form-group col-md-3 col-xl-3">
            ...
            <div class="form-group col-md-3 col-xl-3">
                ...
                <div class="form-group col-md-3 col-xl-3">
                    ...
                    <label>Valor R$</label>
                    {!! Form::number('VALOR', null, ['placeholder' => 'Valor R$:', 'class' => 'form-control',  'step' => 0.01, 'id' => 'VALOR'])!!}
                </div>
            </div> 
            <div class="form-group col-md-12 col-xl-12">
                <div class="form-group col-md-12 col-xl-12">
